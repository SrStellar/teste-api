...
apiRouter.get('/admin/appointments', authMiddleware, requireRole('admin'), async (_req, res) => { const appts = await AppointmentModel.find().populate('barberId', 'name'); res.json(appts); });